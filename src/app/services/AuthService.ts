...
/**
 * Service class for API authentication and request processing
 */
export class AuthService {
   ...
   */
  public validateApiKey(request: NextRequest): boolean {
   ...
   */
  public async validateDeviceToken(request: NextRequest): Promise<string> {
   ...
   */
  public async parseRequestBody<T = Record<string, unknown>>(request: NextRequest): Promise<T> {
    try {
   ...
   */
  public createApiResponse<T extends Record<string, unknown> = Record<string, unknown>>(
    success: boolean, 
    data?: T, 
    error?: string, 
    details?: unknown
